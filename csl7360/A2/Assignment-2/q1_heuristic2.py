...
print('\n\nTime taken for SIFT: {} seconds'.format(time_periods[0]))
print('Time taken for ORB: {} seconds'.format(time_periods[1]))
print('Time taken for BRIEF: {} seconds'.format(time_periods[2]))
